...
# или полный путь:
"C:/Users/espad/AppData/Local/Programs/Python/Python311/Scripts/graphify.exe" update .
```
...
{
  "matcher": "Edit|Write",
  "hooks": [{ "type": "command", "command": "node \"C:/Users/espad/.claude/hooks/my-hook.js\"" }]
}
```

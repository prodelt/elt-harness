...
const MOCKS = {
  // SessionStart hooks
  'session': JSON.stringify({ cwd: 'C:/Users/espad', sessionId: 'test-123' }),
  // PreToolUse Write/Edit
  'edit': JSON.stringify({ tool_name: 'Edit', tool_input: { file_path: 'src/test.ts', content: 'x' }, cwd: 'C:/Users/espad' }),
  // PreToolUse Bash
  'bash': JSON.stringify({ tool_name: 'Bash', tool_input: { command: 'npm test' }, cwd: 'C:/Users/espad' }),
  // PreToolUse Glob/Grep (graphify-preuse)
  'glob': JSON.stringify({ tool_name: 'Glob', tool_input: { pattern: '*.ts' }, cwd: 'C:/Users/espad' }),
  // PostToolUse
  'post_edit': JSON.stringify({ tool_name: 'Edit', tool_input: { file_path: 'src/test.ts' }, tool_response: { content: 'ok' }, cwd: 'C:/Users/espad' }),
  'post_bash': JSON.stringify({ tool_name: 'Bash', tool_input: { command: 'npm test' }, tool_response: { content: 'passed' }, cwd: 'C:/Users/espad' }),
  'post_agent': JSON.stringify({ tool_name: 'Agent', tool_input: { subagent_type: 'code-reviewer' }, tool_response: {}, cwd: 'C:/Users/espad' }),
  'post_skill': JSON.stringify({ tool_name: 'Skill', tool_input: { skill: 'pipeline' }, tool_response: {}, cwd: 'C:/Users/espad' }),
  'post_task': JSON.stringify({ tool_name: 'TaskCreate', tool_input: { title: 'test' }, tool_response: { id: '1' }, cwd: 'C:/Users/espad' }),
  'post_ctx7': JSON.stringify({ tool_name: 'mcp__context7__resolve-library-id', tool_input: { libraryName: 'react' }, tool_response: {}, cwd: 'C:/Users/espad' }),
  // Stop
  'stop': JSON.stringify({ cwd: 'C:/Users/espad', sessionId: 'test-123' }),
  // Notification
  'notification': JSON.stringify({ notification: { type: 'TaskCompleted', taskId: '1' }, cwd: 'C:/Users/espad' }),
  // UserPromptSubmit
  'prompt': JSON.stringify({ prompt: 'Hello', cwd: 'C:/Users/espad', context: { totalTokens: 5000 } }),
  // PreToolUse Read
  'read': JSON.stringify({ tool_name: 'Read', tool_input: { file_path: 'C:/Users/espad/.claude/hooks/test-all-hooks.js' }, cwd: 'C:/Users/espad' }),
};

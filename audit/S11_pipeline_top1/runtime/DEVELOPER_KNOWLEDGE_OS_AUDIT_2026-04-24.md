...
- `C:\Users\user\.claude.json` має duplicate project keys з різним case/path для `D:/Mammoth ERP system`, що підтверджує config drift.
...
9. Task 54: Normalize `C:\Users\user\.claude.json` and project settings.

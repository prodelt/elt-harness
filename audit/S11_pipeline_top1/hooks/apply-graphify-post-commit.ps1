...
$claudeRegistration = Update-HookJson -Path $ClaudeSettings -Command "node `"C:/Users/espad/.claude/hooks/graphify-post-commit.js`""
$codexRegistration = Update-HookJson -Path $CodexHooks -Command "node C:/Users/espad/.claude/hooks/graphify-post-commit.js"

...
$claudeRegistration = Update-HookJson -Path $ClaudeSettings -Command "node `"C:/Users/user/.claude/hooks/context7-tracker.js`""
$codexRegistration = Update-HookJson -Path $CodexHooks -Command "node C:/Users/user/.claude/hooks/context7-tracker.js"

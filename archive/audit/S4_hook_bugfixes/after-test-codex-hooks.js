...
const MOCKS = {
  session:    JSON.stringify({ cwd: 'C:/Users/espad', sessionId: 'codex-test-123' }),
  prompt:     JSON.stringify({ prompt: 'Fix the bug', cwd: 'C:/Users/espad', context: { totalTokens: 5000 } }),
  ...
  stop:       JSON.stringify({ cwd: 'C:/Users/espad', sessionId: 'codex-test-123' }),
};

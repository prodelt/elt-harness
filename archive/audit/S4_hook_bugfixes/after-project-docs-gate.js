...
if (docsCount === 0) {
  ...
  process.stderr.write([
    '╔══════════════════════════════════════════════════════╗',
    '║  PROJECT DOCS MISSING — cannot start session         ║',
    '╚══════════════════════════════════════════════════════╝',
    '',
    'No CLAUDE.md / AGENTS.md / .gemini/GEMINI.md found in:',
    '  ' + cwd,
    '',
    'MANDATORY FIRST ACTION — run:',
    '  /init-project',
    '',
    'This creates all 3 files with real project data.',

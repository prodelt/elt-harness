...
- Files modified (T018): `CLAUDE.md`, `PLAYBOOK.md`, `specs/002-elt-fleet/tasks.md`, `C:\Users\espad\.claude\skills\elt\SKILL.md` (глобальный, вне git-репо, 2.3.0→2.3.1) — Fleet помечен experimental

...
### Test Metrics
- Passed:
  - `node C:\Users\user\.claude\hooks\test-hooks-behavior.js` -> 44/44 PASS
  - `node C:\Users\user\.claude\hooks\test-all-hooks.js` -> 35/35 PASS
  - `node C:\Users\user\.codex\test-codex-hooks.js` -> 46/46 PASS
...
- Global hook runtime files changed:
  - `C:\Users\user\.claude\hooks\context-budget-gate.js`
  - `C:\Users\user\.claude\hooks\session-size-guard.js`
  - `C:\Users\user\.claude\hooks\test-hooks-behavior.js`
- Global hook runtime file created:
  - `C:\Users\user\.claude\hooks\lib\active-window.js`

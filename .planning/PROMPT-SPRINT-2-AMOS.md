...
**Що вже зроблено:**
- `C:\Users\espad\.amos` — git-репо, гілка `amos/sprint1-kernel`
...
Команди старту:
  git -C "C:\Users\espad\.amos" checkout amos/sprint1-kernel
  git -C "C:\Users\espad\.amos" checkout -b amos/sprint2-continuity

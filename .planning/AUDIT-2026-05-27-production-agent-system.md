...
- canonical memory directory: `C:/Users/user/.claude/projects/C--/memory/`
- session start should read `MEMORY.md`.

Observed:
- `C:\Users\user\.claude\projects\C--\memory\MEMORY.md` does not exist.
- `C:\Users\user\.codex\memories\MEMORY.md` also did not resolve during this audit.

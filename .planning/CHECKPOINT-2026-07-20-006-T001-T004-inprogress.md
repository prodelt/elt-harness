...
& node "C:\Claude playground\Pipiline setupper\tools\approval-guard.js" "C:\Users\espad\AppData\Local\Temp\elt-loop-approval-smoke"
Write-Host "EXITCODE=$LASTEXITCODE"   # ожидается 1 (спека unapproved) — до фикса было 0
```
Фикстура для smoke-теста уже создана: `C:\Users\espad\AppData\Local\Temp\elt-loop-approval-smoke`

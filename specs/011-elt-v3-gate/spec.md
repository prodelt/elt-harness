...
- **AC12.** Живой блок в чужом проекте (`C:/Ametrin projects/Route_API_1C`) новым гейтом, без
  правок в том проекте: `block` на диффе с нарушением и `pass`/`l0-clean` на чистом. Пруф — записи
  в его `.git/elt/run-log.jsonl`.

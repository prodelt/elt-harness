...
> **Гейт между T001 и T002:** закрыть хвост 010 — `specs/010-judge-delivery/tasks.md` T004, T006,
> T007, T008 (написаны, зелёные, лежат в дереве, 3/3 PASS). По одному слайсу, уже облегчённым
> гейтом. Батч из 8 упёрся в `DIFF_CAP` — не повторять. 010 закрывается этим целиком.

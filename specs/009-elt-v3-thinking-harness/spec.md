...
- `gate.js:255` обрезает дифф на 12 000 символов. Реальные диффы слайсов в
  `project_social_analysis`: 67K, 66K, 44K, 27K, 25K, 17K — 6 из последних 12 коммитов выше
...
10. Живой прогон ≥4 слайсов на реальном проекте с включённым контуром: все коммиты имеют

...
- `C:/Users/user/.claude/usage-data/report-2026-05-20-084725.html`
- `C:/Users/user/.claude/settings.json`
- `C:/Users/user/.claude/hooks/config.json`
- `C:/Users/user/.codex/config.toml`
- `C:/Users/user/.codex/hooks.json`
- `C:/Users/user/.claude/skill-registry/digests.jsonl`
- `C:/Users/user/.claude/skill-registry/skillsh-installs.json`
- `C:/Users/user/.claude/projects-registry.json`
...
- Direct run error: `EPERM: operation not permitted, open 'C:\Users\user\.claude\projects-dashboard.md'`.
...
```text
node ~/.claude/skills/usage-audit/scripts/parse-report.js C:/Users/user/.claude/usage-data/report-2026-05-20-084725.html

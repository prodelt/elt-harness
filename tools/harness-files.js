...
const HARNESS_OWNED = [
  ...
  // 019 T019: журнал самофиксации. Дописывается в момент, когда кто-то заметил расхождение
  // вердикта с реальностью, — то есть в любой момент любого слайса, включая чужой. Без этой
  // строки первая же запись в журнал приезжала бы в дифф следующего слайса как scope creep,
  // и харнес снова штрафовал бы за файл, который пишет сам.
  '.elt/ledger.jsonl',
];

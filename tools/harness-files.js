...
// (зона слайса) и `fleet/gate.js` (нормализация worktree) держали по своему `isHarnessOwned`,
...
// `elt-gate-l0.js` (`sync-bin.js` CLOSURE): любой его импорт пришлось бы тащить в каждый проект.
